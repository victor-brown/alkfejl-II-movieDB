...
| ---- | ------ | -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DB0  | V0.0.1 | Api kulcsok tárolása                                                 | Adatbázis rendelkezik táblával és a szükséges kapcsolatokkal az adatok tárolására                                                                                                                                                                                                                                               |
| API0 | 0.0.1  | GET végpont API kulcs generálásához                                  | A megadott végpont meghívásával a felhasználó kap egy egyedi kulcsot, illetve egy dátumot ameddig a kulcsal használhatja a védett műveleteket is. (nyitott adminisztrátori jog) Ilyen joggal nem rendelkező felhasználó, csak lekérdezni tud adatokat. Ha rendelkezik kulccsal, akor tud adatot Törölni, Frissíteni, Létrehozni |
| DB1  | 0.0.2  | Zsánerek tárolása                                                    | Adatbázis rendelkezik táblával és a szükséges kapcsolatokkal az adatok tárolására                                                                                                                                                                                                                                               |
| DB2  | 0.0.3  | Színészek tárolása                                                   | Adatbázis rendelkezik táblával és a szükséges kapcsolatokkal az adatok tárolására                                                                                                                                                                                                                                               |
| DB3  | 0.0.4  | Rendezők tárolása                                                    | Adatbázis rendelkezik táblával és a szükséges kapcsolatokkal az adatok tárolására                                                                                                                                                                                                                                               |
| DB4  | 0.0.5  | Filmek tárolása, összekötés a zsánerekkel, színészekkel, rendezőkkel | Adatbázis rendelkezik táblával és a szükséges kapcsolatokkal az adatok tárolására                                                                                                                                                                                                                                               |
| API1 | 1.0.0  | CRUD műveletek a zsánerekhez                                         | Create,Read,Update,Delete műveletek/végpontok a zsánerekhez                                                                                                                                                                                                                                                                     |
| API2 | 1.0.0  | CRUD műveletek a színészekhez                                        | Create,Read,Update,Delete műveletek/végpontok a színészekhez                                                                                                                                                                                                                                                                    |
| API3 | 1.0.0  | CRUD műveletek a rendezőkhöz                                         | Create,Read,Update,Delete műveletek/végpontok a rendezőkhöz                                                                                                                                                                                                                                                                     |
| API4 | 1.0.0  | CRUD műveletek a filmekhez                                           | Create,Read,Update,Delete műveletek/végpontok a filmekhez                                                                                                                                                                                                                                                                       |
